...
from unit8_tools import package_to_hub
...
def parse_args():
    ...
    parser.add_argument("--repo-id", type=str, default="TikhonRadkevich/ppo-CartPole-v1",
                        help="id of the model repository from the Hugging Face Hub {username/repo_name}")

    args_ = parser.parse_args()
    args_.batch_size = int(args_.num_envs * args_.num_steps)
    args_.minibatch_size = int(args_.batch_size // args_.num_minibatches)
    # fmt: on
    return args_
